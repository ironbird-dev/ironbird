...
- Exit codes: 0 success including quiescent headless steps; 1 operation failed; 2 usage or configuration error; 3 applied but not settled; 4 condition not met; 5 nothing to talk to.
...
const USAGE: ReadonlySet<ErrorCode> = new Set(['AMBIGUOUS_TARGET', 'AMBIGUOUS_DEVICE', 'HEADLESS_LOAD_FAILED', 'UNAUTHORIZED', 'PROTOCOL_MISMATCH', 'APP_MISMATCH']);
